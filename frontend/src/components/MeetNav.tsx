    ...
    <header className="sticky top-0 z-20 border-b border-[#1E305B]/80 bg-[#080F20]/90 backdrop-blur-md" data-testid="meet-header">
      ...
      <div className="border-t border-[#1E305B]/70 bg-[#101B35]/70" data-testid="event-details-bar">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-4 gap-y-3 px-4 py-3 sm:grid-cols-4 sm:px-5 lg:px-8">
          ...
          <div data-testid="event-organizers"><p className="event-detail-label">Connect</p><div className="flex flex-wrap gap-x-3 gap-y-1"><a href="https://www.instagram.com/power_aaloo/" target="_blank" rel="noopener noreferrer" className="event-social-link" data-testid="organizer-instagram-power-aaloo" onClick={() => trackEvent("instagram_click", { account: "power_aaloo" })}>@power_aaloo <ExternalLink className="size-3" /></a><a href="https://www.instagram.com/thee_nightowll/" target="_blank" rel="noopener noreferrer" className="event-social-link" data-testid="organizer-instagram-nightowll" onClick={() => trackEvent("instagram_click", { account: "thee_nightowll" })}>@thee_nightowll <ExternalLink className="size-3" /></a><a href="https://www.instagram.com/iitbhupowerlifting/" target="_blank" rel="noopener noreferrer" className="event-social-link" data-testid="organizer-instagram-iit-bhu-powerlifting" onClick={() => trackEvent("instagram_click", { account: "iitbhupowerlifting" })}>@iitbhupowerlifting <ExternalLink className="size-3" /></a></div></div>
        </div>
      </div>
    </header>
  );
